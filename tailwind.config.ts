  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "slide-up": { "0%": { opacity: "0", transform: "translateY(100px)" }, "100%": { opacity: "1", transform: "translateY(0)" } },
        "scale-in": { "0%": { opacity: "0", transform: "scale(0.9)" }, "100%": { opacity: "1", transform: "scale(1)" } },
        glow: {
          "0%, 100%": { filter: "brightness(1) drop-shadow(0 0 20px hsl(var(--hero-glow) / 0.3))" },
          "50%": { filter: "brightness(1.1) drop-shadow(0 0 30px hsl(var(--hero-glow) / 0.5))" },
        },
